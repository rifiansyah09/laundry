...
<div class="container">
        <div class="alert alert-info text-center">
                <h4 style="margin-buttom: 0px:"><b>Selamat Datang!di Sistem Informasi Laundry</b></h4>
        </div>
        <div class="panel">
                                                ...
                                                <div class="panel-heading">
                                                        <h1>
                                                                ...
                                                                <span class="pull-right">
                                                                        <?php
                                                                        $pelanggan = mysqli_query($koneksi,"select * from pelangggan");
        ...
        <div class="panel">
                ...
                <div class="panel-body">
                        <table class="table table-bordered table-striped">
                                ...
                                <?php
                                     $data = mysqli_query($koneksi,"select * from pelangggan,transaksi where transaksi_pelanggan=pelanggan_id order by transaksi_id desc limit 10");
                                     $no = 1;
